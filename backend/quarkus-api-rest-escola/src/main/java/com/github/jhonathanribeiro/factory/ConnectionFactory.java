package com.github.jhonathanribeiro.factory;
...
public class ConnectionFactory {
   ...
   private static final String DATABASE_URL = "jdbc:postgresql://localhost:5432/escola";
   /**
   ...
   */
   public static Connection createConnectionToPostgresSQL() throws Exception{
      Class.forName("com.postgresql.jdbc.Driver"); //Faz com que a classe seja carregada pela JVM
